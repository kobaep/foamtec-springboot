        ...
        <div class="col-sm-12">
            <form class="form-horizontal">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 control-label">Tooling No. Or Method :</label>
                        <div class="col-sm-8">
                            <label class="form-control-static">${faRequest.methodFirst}</label>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label">First Qty :</label>
                        <div class="col-sm-8">
                            <label class="form-control-static">${faRequest.qtyFirst}</label>
                        </div>
                    </div>
                </div>
            </form>
    ...
    $(document).ready(function() {
        ...
        $("#btnApproveReason").click(function() {
            var data = {
                ...
                action : "qaApproveFirstShot"
            };
            $.ajax({
                url: "${home}fams/qaPrivate/approveFirst",
                type: "POST",
                headers: {
        ...
        $("#btnRejectReason").click(function() {
            var data = {
                inputId : "${faRequest.id}",
                action : "qaRejectFirstShot",
                inputReason : $("#inputReason").val()
            };
            $.ajax({
                url: "${home}fams/qaPrivate/rejectFirst",
                type: "POST",
                headers: {
                    Accept: "application/json"
                },
